...
GO
/****** Object:  StoredProcedure [dbo].[sp_Axtria_Redemption_Report]    Script Date: 7/18/2018 12:49:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[sp_Axtria_Redemption_Report]
AS
SET NOCOUNT ON;
...
Axtria.DBO.inPhysicianFaxRaw	--inPhysicianFaxRaw_20180402
Axtria.DBO.tblFullFeedImportAllApprovedClaims_fullhistory
Axtria.DBO.tblImportCustNomProf
Axtria.DBO.tblImportCustTerr
Axtria.DBO.tblImportGeoTerr
Axtria.DBO.tblImportTerrHierarchy
Axtria.DBO.tblImportTarget
Axtria.DBO.tblImportAmaPDRP
Axtria.DBO.tblImportRepTerr
Axtria.DBO.inINBURoster_Test	--internal test
Axtria.DBO.inINBURoster		--inINBURoster_20180612
...
--For WebTeam
SELECT * FROM Axtria.DBO.V_RepRoster
SELECT * FROM Axtria.DBO.V_DateConfig
...
LEFT JOIN Axtria.DBO.tblFullFeedImportAllApprovedClaims_fullhistory D ON C.tblClaimID = D.tblClaimID
...
FROM Axtria.DBO.inPhysicianFaxRaw
) B ON A.NPI = B.NPI
...
--Get Cusotmer Info
/*
SELECT NPI#,COUNT(DISTINCT CUSTOMER_NUMBER) FROM Axtria.DBO.tblImportCustNomProf WHERE NPI# IS NOT NULL
...
INNER JOIN (
	...
	FROM Axtria.DBO.tblImportCustNomProf
...
FROM Axtria.DBO.tblImportCustTerr
...
FROM Axtria.DBO.tblImportGeoTerr 
WHERE FIELD_FORCE_NAME IN ('INBU APEX SF','INBU PINNACLE SF','INBU SUMMIT SF')
...
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportCustTerr B ON A.CustomerID = 'N_'+B.CUSTOMER_NUMBER AND B.FIELD_FORCE_NAME = 'INBU APEX SF'

UPDATE A
SET APEX_Terr = B.TERRITORY_NUMBER, APEX_TerrName = B.TERRITORY_NAME
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.Zip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU APEX SF'
WHERE A.APEX_Terr IS NULL

UPDATE A
SET APEX_Terr = B.TERRITORY_NUMBER, APEX_TerrName = B.TERRITORY_NAME
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.PatientZip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU APEX SF'
WHERE A.APEX_Terr IS NULL

--UPDATE A
--SET APEX_Terr = B.TERRITORY_NUMBER, APEX_TerrName = B.TERRITORY_NAME
--FROM DBO.tblTransactions A
--INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.PharmacyZip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU APEX SF'
...
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportCustTerr B ON A.CustomerID = 'N_'+B.CUSTOMER_NUMBER AND B.FIELD_FORCE_NAME = 'INBU PINNACLE SF'

UPDATE A
SET PINNACLE_Terr = B.TERRITORY_NUMBER, PINNACLE_TerrName = B.TERRITORY_NAME
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.Zip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU PINNACLE SF'
WHERE A.PINNACLE_Terr IS NULL

UPDATE A
SET PINNACLE_Terr = B.TERRITORY_NUMBER, PINNACLE_TerrName = B.TERRITORY_NAME
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.PatientZip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU PINNACLE SF'
WHERE A.PINNACLE_Terr IS NULL

--UPDATE A
--SET PINNACLE_Terr = B.TERRITORY_NUMBER, PINNACLE_TerrName = B.TERRITORY_NAME
--FROM DBO.tblTransactions A
--INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.PharmacyZip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU PINNACLE SF'
...
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportCustTerr B ON A.CustomerID = 'N_'+B.CUSTOMER_NUMBER AND B.FIELD_FORCE_NAME = 'INBU SUMMIT SF'

UPDATE A
SET SUMMIT_Terr = B.TERRITORY_NUMBER, SUMMIT_TerrName = B.TERRITORY_NAME
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.Zip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU SUMMIT SF'
WHERE A.SUMMIT_Terr IS NULL

UPDATE A
SET SUMMIT_Terr = B.TERRITORY_NUMBER, SUMMIT_TerrName = B.TERRITORY_NAME
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.PatientZip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU SUMMIT SF'
WHERE A.SUMMIT_Terr IS NULL

--UPDATE A
--SET SUMMIT_Terr = B.TERRITORY_NUMBER, SUMMIT_TerrName = B.TERRITORY_NAME
--FROM DBO.tblTransactions A
--INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.PharmacyZip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU SUMMIT SF'
...
INNER JOIN (
	...
	FROM Axtria.DBO.tblImportTerrHierarchy 
...
FROM Axtria.DBO.tblImportTarget
WHERE FIELD_FORCE_NAME IN ('INBU APEX SF','INBU PINNACLE SF','INBU SUMMIT SF')
GROUP BY CUSTOMER_NUMBER, FIELD_FORCE_NAME
...
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportTarget B ON A.CustomerID = 'N_'+B.CUSTOMER_NUMBER
...
FROM DBO.tblTransactions A
INNER JOIN Axtria.DBO.tblImportAmaPDRP B ON A.CustomerID = 'N_'+B.GCO_BUSINESS_PARTY_NUMBER
...
INNER JOIN Enbrel_Production.DBO.tblDoctors B ON A.DoctorID = B.tblDoctorsID
INNER JOIN Axtria.DBO.tblImportCustNomProf C ON B.PhysicianNPI = C.NPI#

UPDATE A
SET CustomerID = 'N_'+C.CUSTOMER_NUMBER
FROM  tblActivations A 
INNER JOIN Enbrel_Production.DBO.tblDoctors B ON A.DoctorID = B.tblDoctorsID
INNER JOIN Axtria.DBO.tblImportCustNomProf C 
...
SET APEX_Terr = B.TERRITORY_NUMBER, APEX_TerrName = B.TERRITORY_NAME
FROM DBO.tblActivations A
INNER JOIN Axtria.DBO.tblImportCustTerr B ON A.CUSTOMER_NUMBER = 'N_'+B.CUSTOMER_NUMBER AND B.FIELD_FORCE_NAME = 'INBU APEX SF'
...
SET APEX_Terr = B.TERRITORY_NUMBER, APEX_TerrName = B.TERRITORY_NAME
FROM DBO.tblActivations A
INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.PhysicianZip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU APEX SF'
WHERE A.APEX_Terr IS NULL
...
SET PINNACLE_Terr = B.TERRITORY_NUMBER, PINNACLE_TerrName = B.TERRITORY_NAME
FROM DBO.tblActivations A
INNER JOIN Axtria.DBO.tblImportCustTerr B ON A.CUSTOMER_NUMBER = 'N_'+B.CUSTOMER_NUMBER AND B.FIELD_FORCE_NAME = 'INBU PINNACLE SF'
...
SET PINNACLE_Terr = B.TERRITORY_NUMBER, PINNACLE_TerrName = B.TERRITORY_NAME
FROM DBO.tblActivations A
INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.PhysicianZip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU PINNACLE SF'
WHERE A.PINNACLE_Terr IS NULL
...
SET SUMMIT_Terr = B.TERRITORY_NUMBER, SUMMIT_TerrName = B.TERRITORY_NAME
FROM DBO.tblActivations A
INNER JOIN Axtria.DBO.tblImportCustTerr B ON A.CUSTOMER_NUMBER = 'N_'+B.CUSTOMER_NUMBER AND B.FIELD_FORCE_NAME = 'INBU SUMMIT SF'
...
SET SUMMIT_Terr = B.TERRITORY_NUMBER, SUMMIT_TerrName = B.TERRITORY_NAME
FROM DBO.tblActivations A
INNER JOIN Axtria.DBO.tblImportGeoTerr B ON A.PhysicianZip = B.POSTAL_CODE AND B.FIELD_FORCE_NAME = 'INBU SUMMIT SF'
WHERE A.SUMMIT_Terr IS NULL
...
WHERE GEO NOT IN (
SELECT TERRITORY_NUMBER FROM Axtria.DBO.tblImportRepTerr
WHERE PRIMARY_TERRITORY = 'Y' AND IS_ACTIVE = 'Y'
)

SELECT * FROM Enbrel_GEOlevelreport.DBO.V_OutputGeo
WHERE GEO NOT IN (
SELECT [Territory #] FROM Axtria.DBO.inINBURoster
WHERE Flag = 'PRI' AND FFName IN ('INBU APEX SF','INBU PINNACLE SF','INBU SUMMIT SF')
)

SELECT * INTO Axtria.DBO.inINBURoster_Test
FROM Axtria.DBO.inINBURoster WHERE 1 = 0

INSERT INTO Axtria.DBO.inINBURoster_Test (Email, [Territory #], [Territory Description])
...
NPI,
COUNT(CASE WHEN Year_ID = 1 THEN 1 ELSE NULL END) AS CYTD_Transactions,
COUNT(CASE WHEN Year_ID = 2 AND Date_Name <= @End_Date THEN 1 ELSE NULL END) AS PYTD_Transactions,
